#!/bin/bash
# https://raw.githubusercontent.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver/refs/heads/master/deploy/kubernetes/deploy-driver.sh
...
${KUBECTL} version
${KUBECTL} kustomize ./overlays/stable-master/ > ./csi-manifests.yaml
#${KUBECTL} kustomize ./overlays/stable-master/ | ${KUBECTL} apply -v="${VERBOSITY}" -f -
