...
helm upgrade -i kedify-otel oci://ghcr.io/kedify/charts/otel-add-on --version=v0.0.6  --set opentelemetry-collector.enabled=false --set settings.metricStoreRetentionSeconds=7 --set validatingAdmissionPolicy.enabled=false
